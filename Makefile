...
ACLOCAL = ${SHELL} "/u/mmadden/Game Tech/DodgeBall/missing" --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} "/u/mmadden/Game Tech/DodgeBall/missing" --run autoconf
AUTOHEADER = ${SHELL} "/u/mmadden/Game Tech/DodgeBall/missing" --run autoheader
AUTOMAKE = ${SHELL} "/u/mmadden/Game Tech/DodgeBall/missing" --run automake-1.11
AWK = gawk
BULLET_CFLAGS = 
BULLET_LIBS = 
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} "/u/mmadden/Game Tech/DodgeBall/missing" --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 0.1
abs_builddir = /u/mmadden/Game Tech/DodgeBall
abs_srcdir = /u/mmadden/Game Tech/DodgeBall
abs_top_builddir = /u/mmadden/Game Tech/DodgeBall
abs_top_srcdir = /u/mmadden/Game Tech/DodgeBall
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} '/u/mmadden/Game Tech/DodgeBall/install-sh'
