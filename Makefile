...
ACLOCAL = ${SHELL} "/u/binary4/Game Tech/dodgeball/Updated/missing" --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} "/u/binary4/Game Tech/dodgeball/Updated/missing" --run autoconf
AUTOHEADER = ${SHELL} "/u/binary4/Game Tech/dodgeball/Updated/missing" --run autoheader
AUTOMAKE = ${SHELL} "/u/binary4/Game Tech/dodgeball/Updated/missing" --run automake-1.11
AWK = gawk
BULLET_CFLAGS = 
BULLET_LIBS = 
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} "/u/binary4/Game Tech/dodgeball/Updated/missing" --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 0.1
abs_builddir = /u/binary4/Game Tech/dodgeball/Updated
abs_srcdir = /u/binary4/Game Tech/dodgeball/Updated
abs_top_builddir = /u/binary4/Game Tech/dodgeball/Updated
abs_top_srcdir = /u/binary4/Game Tech/dodgeball/Updated
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} '/u/binary4/Game Tech/dodgeball/Updated/install-sh'
